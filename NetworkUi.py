...
class Ui_FormNetwork(object):
    def setupUi(self, FormNetwork):
        ...
        self.pushButtonJoin = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.pushButtonJoin.setObjectName("pushButtonJoin")
        self.horizontalLayout_2.addWidget(self.pushButtonJoin)
    ...
    def retranslateUi(self, FormNetwork):
        ...
        self.pushButtonJoin.setText(_translate("FormNetwork", "加入游戏"))
